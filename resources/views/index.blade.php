          ...
          <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
              ...
              <div class="offcanvas-footer d-lg-none">
                <div>
                  <a href="mailto:info@zee-tech.ng" class="link-inverse">info@zee-tech.ng</a>
            ...
            <div class="col-lg-5">
              ...
              <div class="d-flex flex-row">
                ...
                <div>
                  ...
                  <p class="mb-0"><a href="mailto:info@zee-tech.ng" class="link-body">info@zee-tech.ng</a></p>
                </div>
              </div>
            </div>
            <!--/column -->
      ...
      <div class="row gy-6 gy-lg-0">
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <a href="mailto:#">info@zee-tech.ng</a><br /> 00 (123) 456 78 90
          </div>
          <!-- /.widget -->
        </div>
        <!-- /column -->
